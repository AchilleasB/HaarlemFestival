...
public function orderManagement()
    ...
    public function updateEventDetails() {
        ...
        foreach ($eventsData as $eventId => $eventDetails) {
            ...
            $id = $eventId;
            $title = isset($eventDetails['title']) ? $eventDetails['title'] : '';
            $subTitle = isset($eventDetails['subTitle']) ? $eventDetails['subTitle'] : '';
            $description = isset($eventDetails['description']) ? $eventDetails['description'] : '';
            $locations = isset($eventDetails['locations']) ? $eventDetails['locations'] : '';
            $schedule = isset($eventDetails['schedule']) ? $eventDetails['schedule'] : '';
            $eventImage = isset($eventDetails['event_image']) ? $eventDetails['event_image'] : '';
            $buttonPath = isset($eventDetails['button_path']) ? $eventDetails['button_path'] : '';
...
{
$this->createEntity('HistoryTour', ['date' => 'date', 'time' => 'time', 'guide' => 'guide', 'seats' => 'seats'],
$this->historyTourService);

}
public function createLocation()
{
$this->createEntity('Location', ['locationName' => 'location_name', 'address' => 'address', 'description' =>
'description', 'links' => 'links'], $this->locationService);
