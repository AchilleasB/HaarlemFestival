<section class="container border-secondary">
    <form id="ticketForm" class="mt-5" data-user-id="<?php echo isset($_SESSION['user_id']) ? $_SESSION['user_id'] : ''; ?>">
        <div class="row mb-3">
            <div class="col">
        ...
        <div class="row p-5 mt-5">
            <div class="col text-center">
                <button type="submit" class="btn btn-block btn-warning text-white">Add to Cart <i class="bi bi-cart4"></i></button>
            </div>
        </div>
    </form>
</section>
