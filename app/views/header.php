...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
        <img src="/../icons/haarlem-logo.svg" class="header-logo w-25 h-20" alt="Visit Haarlem icon" id="logo">
                ...
                <ul class="navbar-nav">
                    ...
                    <?php } else { ?>
                        ...
                        <?php if ($_SESSION['user_role'] == 'employee') { ?>
                            <li class="nav-item">
                                <a class="nav-link" href="/qrCodeChecker"><i class="fa-solid fa-clipboard"></i> QR code checker</a>
                            </li>
                        <?php } ?>
                        <?php if ($_SESSION['user_role'] == 'customer') { ?>
                            <li class="nav-item">
                                <a class="nav-link" href="/shoppingCart"><i class="fa-solid fa-cart"></i> Shopping cart</a>
                            </li>
                        <?php } ?>
                        <li class="nav-item">
